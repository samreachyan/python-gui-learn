...
def save_note():
    ...
    save_name = filedialog.asksaveasfilename(
        initialdir="./", title="Save Note", filetypes=(("Text Files", "*.txt"), ("All Files", "*.*")))
...
close_button = tkinter.Button(
    menu_frame, image=close_image, command=close_note)
...
font_family_drop = tkinter.OptionMenu(
...
font_size = IntVar()
font_size_drop = tkinter.OptionMenu(
...
font_option_drop = tkinter.OptionMenu(
